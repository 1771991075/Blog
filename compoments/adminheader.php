<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="position: fixed; height: 100vh; width: 280px;">
    ...
    <ul id="nav" class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="/admin/alter.php" class="nav-link text-white <?php echo $currentPage == "alter" ? "active" : ""; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
