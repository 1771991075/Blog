...
<body>
  ...
  <div class="container-fulid">
    <a class="an">
      <span>
        <svg onclick="$('html,body').animate({ scrollTop: 775 }, 50);" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-chevron-compact-down animate__animated animate__bounce animate__slow animate__infinite" viewBox="0 0 16 16">
